...
<main>
	<div class="col-10">
		...
		<form action="cad_form.php" method="post" id="form-contato">
			<div class="signup">
				<?php
				...
				<div class="form-item">
					Sexo:<label><input type="radio" name="sexo" value="<?=isset($sexo) ? $sexo : '';?>" checked>Masculino</label><label><input type="radio" name="sexo" value="<?=isset($sexo) ? $sexo : '';?>">Feminino</label>
				</div>
				<div class="form-item">
				...
				<a href="destino">Ver Termos de uso</a>
				<div class="form-item">
