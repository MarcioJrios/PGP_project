					...
					<form action="cadastro_usuario.php" method="post" id="signup-form" class="signup-form">
						...
						<div class="form-row">	
							...
							<div class="form-radio">
								...
								<div class="form-flex">
									<input type="radio" id="male" name="sexo" value="m" checked="checked"/><label for="male">Masculino</label>
									
									<input type="radio" name="sexo" id="female" value="f"/><label for="female">Feminino</label>
								</div>	
							</div>
						</div>
							<div class="form-group">
